...
+html_head: <style>
+begin_src css :exports results
body {
  font-family: "Work Sangs", sans-serif;
  color: #222;
}
h1 {
  color: #2e2dcb;
 ...
 * John Doe
   ...
   <p><strong>Frontend Developer</string><br/>
...
#+begin_src elisp
  ...
  ;;  :after org)
#+end_src
This is already there therefore deactivated!
C-c C-e p p
...
org -> HTML -> pdf     C-c e p



Verify org    M-x org-version
Where it comes from   C-h v org-load-path ;; doesn't exist
